#script to Download a Youtube movie, extract frames, process them with deepdream, and generate a resulting movie

#Charlie bit my Finger movie
...
docker run -d --name deepdream-json --volumes-from deepdream-compute ubuntu:14.04 /bin/bash -c "cd /opt/deepdream && ./make_json.sh"
